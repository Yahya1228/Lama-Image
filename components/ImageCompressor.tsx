      ...
      {!selectedFile ? (
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="relative group rounded-3xl overflow-hidden bg-slate-50 dark:bg-slate-900 border border-slate-100 dark:border-slate-700 aspect-video flex items-center justify-center">
            ...
            <button 
              onClick={clear}
              className="absolute top-4 right-4 w-11 h-11 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all shadow-xl border border-slate-100 dark:border-slate-700"
              title="Remove image"
            >
          ...
          {!result && !isProcessing && (
            <button 
              ...
              className="group w-full bg-primary-600 hover:bg-primary-700 text-white font-black py-5 rounded-[24px] shadow-2xl shadow-primary-500/30 transition-all active:scale-[0.98] flex items-center justify-center space-x-3 overflow-hidden relative"
            >
